...
function multiply(a,b){ //eslint-disable-line
  var theProduct = a * b;
  var note = 'The product of ' + a + ' and ' + b + ' is ' + theProduct + '.';
  return[theProduct, note];
}
...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var message =  + a + ' and ' + b + ' and ' + c + ' sum to ' + secondSum + '.';
  var message1 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + secondMultiply + '.';
  return [secondSum, secondMultiply, message, message1];
...
function sumArray(testArray){ //eslint-disable-line
  for (var i = 0; i < testArray.length; i++){
    var sumArr = sum(num, testArray[i])[0];
    num = sumArr;
  }
var message4 = + testArray[0] + ','+ testArray[1] + ','+ testArray[2] +' was passed in as an array of numbers, and ' + sumArr + ' is their sum.';
return [sumArr, message4];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  for (var i = 0; i < testArray.length; i++){
    var productArr = multiply(num1, testArray[i])[0];
    num1 = productArr;
  }
var message5 = 'The numbers '+ testArray[0] + ','+ testArray[1] + ','+ testArray[2] +' have a product of ' + productArr + '.';
return [productArr, message5];
} 
